...
document.querySelector('.button--gray').addEventListener('click', (event) => {
    ...
    Swal.fire({
        ...
        html: `
            ...
            <input type="text" id="creditCard" class="swal2-input" placeholder="Tarjeta de crédito">
        ...
        preConfirm: () => {
            ...
            if (!email || !creditCard || !dni) {
                Swal.showValidationMessage(`Por favor completa todos los campos`);
            }
            
            return { email, creditCard, dni };
        }
    }).then((result) => {
        if (result.isConfirmed) {
            ...
            Swal.fire({
                ...
                confirmButtonColor: 'hsl(31, 100%, 70%)',
                ...
                if (result.isConfirmed) {
                    ...
                    Swal.fire({
                        ...
                        text: 'La compra se finalizó con éxito',
                        icon: 'success',
...
function showAlert() {
    Swal.fire({
        title: "Bien Hecho!",
        text: "Agregaste el producto a tu carrito con éxito!",
        icon: "success",
